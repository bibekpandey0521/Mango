    ...
    public class CartAPIController : ControllerBase
    {
        ...
        public async Task<ResponseDto> GetCart(string userId)
        {
            try
            {
                ...
                {
                    Console.WriteLine(cart.CartHeader.CouponCode);
                    CouponDto coupon = await _couponService.GetCoupon(cart.CartHeader.CouponCode);
                    

                    Console.WriteLine($"Code: {coupon?.CouponCode}");
                    Console.WriteLine($"Discount: {coupon?.DiscountAmount}");
                    Console.WriteLine($"MinAmount: {coupon?.MinAmount}");
